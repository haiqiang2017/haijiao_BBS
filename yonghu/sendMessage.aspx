<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sendMessage.aspx.cs" Inherits="yonghu_sendMessage" %>
        ...
        <tr>
            ...
            <tr>
                <td align="center" colspan="2" bgcolor="#99ccff">
                    <asp:Label ID="Label1" runat="server" Font-Size="X-Large" Text="发送短消息" Font-Bold="True" ForeColor="White"></asp:Label></td>
            </tr>
