...
function Ok() {
    ...
    SetAttribute(oLink, 'innerHTML', GetE('txtAttTitle').value);
...
function BrowseServer() {
    OpenFileBrowser(FCKConfig.BBSPath + '/Pages/FileUpLoad.aspx?ParentID=' + FCKConfig.BBSImageParentID, FCKConfig.LinkBrowserWindowWidth, FCKConfig.LinkBrowserWindowHeight);
}
