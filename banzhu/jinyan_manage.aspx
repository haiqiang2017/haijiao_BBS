<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jinyan_manage.aspx.cs" Inherits="banzhu_jinyan_manage" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
  ...
  <script type="text/javascript">
          ...
          $('#dg').datagrid({
             ...
             //     alert("我爱学习");
                  ddv.panel({
                      border: false,
                      cache: true,                    
                      href: 'input_jinyan.aspx?index=' + index,
                      onLoad: function () {
      ...
      function saveItem(index) {
          ...
          //     alert(row);
          alert(row.ID);
        //  var url = 'update_jinghua.ashx?ID=' + row.ID;
         //注意此处ID='+row.ID;之间不能有任何空格
          var url = 'update_jinyan.ashx?ID='+row.ID;
          // alert(url);
