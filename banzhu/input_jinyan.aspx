<%@ Page Language="C#" AutoEventWireup="true" CodeFile="input_jinyan.aspx.cs" Inherits="banzhu_input_jinyan" %>
...
<table class="auto-style1" 
		...
		<tr>
			...
			<td class="style24"><input name="NAME" id="NAME" class="easyui-validatebox" readonly="readonly"/></td>   
        	<td class="style3">禁言管理</td>
			<td class="style24">    
                <select class="easyui-combobox"  name="jyzt" id="jyzt"  runat="server" style="width:153px; height:23px;">
