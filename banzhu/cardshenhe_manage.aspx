<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cardshenhe_manage.aspx.cs" Inherits="banzhu_cardshenhe_manage" %>
      ...
      <script type="text/javascript">
       ...
       <script type="text/javascript">
                ...
                $('#dg').datagrid({
                    ...
                    onExpandRow: function (index, row) {
                        ...
                        ddv.panel({
                            border: false,
                            cache: true,
                            href: "input_shenhe.aspx?index=" + index,
                            onLoad: function () {
            ...
            function saveItem(index) {
                ...
                //   alert(row);
                alert("我爱学习");
                var url =  'update_shenhe.ashx?ID=' + row.ID;
                // alert(url);
                    ...
                    $.messager.confirm('提示', '你确定要删除已选记录吗?', function (r) {
                        if (r) {
                            for (var i = rows.length - 1; i >= 0; --i) {
                                $.ajax({
                                    type: "post",
                                    url: "../guanliyuan/destroy/destroy_card.ashx",
                                    data: "ID=" + rows[i].ID,
                                    async: false,
                                    success: function (data) {
                                        if (data == "1") {
