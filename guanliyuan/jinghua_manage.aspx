<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jinghua_manage.aspx.cs" Inherits="guanliyuan_jinghua_manage" %>
       ...
       <script type="text/javascript">
            $(function () {
              ...
              onExpandRow: function (index, row) {
                  ...
                  ddv.panel({
                      border: false,
                      cache: true,
                      href: "input_jinghua.aspx?index=" + index,
                      onLoad: function () {
           ...
           function destroyItem() {                   //姜海强  可批量删除 2017-07-06 改
            ...
            function saveItem(index) {
                ...
                alert(row);
                var url = 'update/update_jinghua.ashx?ID=' + row.ID;
                // alert(url);
