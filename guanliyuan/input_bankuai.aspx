<%@ Page Language="C#" AutoEventWireup="true" CodeFile="input_bankuai.aspx.cs" Inherits="guanliyuan_input_bankuai" %>
...
<table class="auto-style1" 
		...
		<tr>
			<td class="style3">板块名</td>
			<td class="style24"><input name="BKM" id="BKM" class="easyui-validatebox" required="true"/></td>        
            <td class="style3">版主</td>
           	<td class="style14"><input name="BZ" class="easyui-combobox" id="BZ" required="true"  readonly ="readonly"/></td>
        </tr>
           </table>
